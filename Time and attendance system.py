...
path = r"C:\Users\VictorAdeife\PycharmProjects\pythonProject1\Personal\images\train"
images = []
classNames = []
...
def markAttendance(name):
    with open(r'C:\Users\VictorAdeife\PycharmProjects\pythonProject1\Attendance.csv', 'r+') as f:
